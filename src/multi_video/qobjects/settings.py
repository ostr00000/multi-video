...
from pyqt_settings.field.simple import BoolField, IntField, PathField, StrField
...
class _Settings(QSettings):
    ...
    VIDEO_PLAYER.widgetFactory = WidgetFactory(
        ComboBoxFieldWidget, items=['vlc', 'mpv']
    )
    ...
    MINIMAL_LENGTH_TO_ACTIVATE_RANDOM_PART = IntField(
        'video/minimal_length', default=120
    )
